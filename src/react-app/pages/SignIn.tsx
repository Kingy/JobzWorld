    ...
    <div className="min-h-screen bg-grey-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-grey-600">Sign in to your Jobzworld account</p>
        </div>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm border border-grey-200 sm:rounded-lg sm:px-10">
          {/* User Type Toggle */}
          <div className="mb-6">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-3 py-2 border border-grey-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  placeholder="Enter your email"
                />
                <Mail className="absolute left-3 top-2.5 h-5 w-5 text-grey-400" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-10 py-2 border border-grey-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  placeholder="Enter your password"
                />
                <Lock className="absolute left-3 top-2.5 h-5 w-5 text-grey-400" />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-2.5 h-5 w-5 text-grey-400 hover:text-grey-600"
                >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-primary-500 focus:ring-primary-500 border-grey-300 rounded"
                />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-grey-300 rounded-lg shadow-sm bg-white text-sm font-medium text-grey-500 hover:bg-grey-50 transition-colors">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-grey-600">
              ...
              <Link 
                to={userType === 'candidate' ? '/candidate-onboarding' : '/employer-onboarding'}
